...
@AndroidEntryPoint
class FSituationAuto4 : Fragment() {

    private lateinit var binding: FragmentSituationAutoS4Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSituationAutoS4Binding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    private fun parseParams() {
      ...
      //  Toast.makeText(getActivity(),"first choice" + situation3, Toast.LENGTH_SHORT).show()
    }
    ...
    fun launchFragmentNext() {
        ...
        val btnArgsAuto = Bundle().apply {
            putString(FSituationAuto5.SITUATION_ITEM, situation3 + "&" +radioSelect)
        }

        navController = Navigation.findNavController(activity!!, R.id.nav_host_fragment)
        navController.navigate(R.id.action_FSituationAuto4_to_FSituationAuto5, btnArgsAuto)
    }
