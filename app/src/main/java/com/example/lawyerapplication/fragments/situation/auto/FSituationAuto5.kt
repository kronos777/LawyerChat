...
@AndroidEntryPoint
class FSituationAuto5 : Fragment() {

    private lateinit var binding: FragmentSituationAutoS5Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSituationAutoS5Binding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    private fun parseParams() {
        ...
        situation4 = args.getString(SITUATION_ITEM).toString()
        //Toast.makeText(getActivity(),"first choice" + situation4, Toast.LENGTH_SHORT).show()
    }
    ...
    fun launchFragmentNext() {
        ...
        val btnArgsAuto = Bundle().apply {
            putString(FSituationAuto6.SITUATION_ITEM, situation4 + "&" +radioSelect)
        }

        navController = Navigation.findNavController(activity!!, R.id.nav_host_fragment)
        navController.navigate(R.id.action_FSituationAuto5_to_FSituationAuto6, btnArgsAuto)
    }
