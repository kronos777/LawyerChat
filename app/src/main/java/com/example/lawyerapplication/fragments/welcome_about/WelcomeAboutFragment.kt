package com.example.lawyerapplication.fragments.welcome_about
...
class WelcomeAboutFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootLayout: View =
            inflater.inflate(R.layout.fragment_welcome_about, container, false)
    ...
    companion object {
        ...
        fun newInstance(
            ...
            description: String?,
            imageResource: Int
        ): WelcomeAboutFragment {
            val fragment = WelcomeAboutFragment()
            val args = Bundle()
