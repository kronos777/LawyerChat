...
import com.example.lawyerapplication.fragments.situation.clothing.FSituationClothing6Args
...
@AndroidEntryPoint
class FSituationFurniture5 : Fragment() {

    private lateinit var binding: FragmentSituationFurnitureS5Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSituationFurnitureS5Binding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    fun launchFragmentNext() {
        navController.navigate(R.id.action_FSituationFurniture5_to_FSituationFinish)
    }
