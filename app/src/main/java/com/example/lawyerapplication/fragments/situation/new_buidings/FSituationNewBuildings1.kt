...
import com.example.lawyerapplication.databinding.FragmentSituationNewBuildingsS1Binding
...
@AndroidEntryPoint
class FSituationNewBuildings1 : Fragment() {

    private lateinit var binding: FragmentSituationNewBuildingsS1Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSituationNewBuildingsS1Binding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    fun launchFragmentNext() {
        ...
        navController.navigate(R.id.action_FSituationNewBuildings1_to_FSituationNewBuildings2)
    }
