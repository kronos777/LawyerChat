...
@AndroidEntryPoint
class FSituationAuto6 : Fragment() {

    private lateinit var binding: FragmentSituationAutoS6Binding
    ...
    private var situation5: String = String()
    ...
    override fun onCreateView(
        ...
        binding = FragmentSituationAutoS6Binding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    private fun parseParams() {
        ...
        situation5 = args.getString(SITUATION_ITEM).toString()
        //Toast.makeText(getActivity(),"first choice" + situation5, Toast.LENGTH_SHORT).show()
    }


    fun launchFragmentNext() {
        val btnArgsAuto = Bundle().apply {
            putString(FSituationAuto7.SITUATION_ITEM, situation5 + "&" +radioSelect)
        }


        navController = Navigation.findNavController(activity!!, R.id.nav_host_fragment)
        navController.navigate(R.id.action_FSituationAuto6_to_FSituationAuto7, btnArgsAuto)
    }
