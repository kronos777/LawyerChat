...
import com.example.lawyerapplication.fragments.group_chat_home.AdGroupChatHome
import com.example.lawyerapplication.fragments.single_chat_home.AdSingleChatHome
import com.example.lawyerapplication.models.Contact
...
import com.example.lawyerapplication.activities.ActSplash
import com.example.lawyerapplication.core.*
...
object UserUtils {
    ...
    fun updateContactsProfiles(listener : QueryCompleteListener?): Boolean {
        ...
        Timber.v("Query Called {$listOfMobiles.size}")
